...
const cspHeader = `
    ...
    connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.clarity.ms https://o4511865256214528.ingest.us.sentry.io;
    font-src 'self';
    object-src 'none';
    base-uri 'self';
    form-action 'self';
